(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
      ...
      ((t = t ? encodeURIComponent(t).replace(/%3A/i, ":") + "@" : ""),
        e.host
          ...
          : r &&
            ((s = t + (~r.indexOf(":") ? `[${r}]` : r)),
            e.port && (s += ":" + e.port)),
        a && "object" == typeof a && (a = String(u.urlQueryToSearchParams(a))));
      let c = e.search || (a && `?${a}`) || "";
      return (
        n && !n.endsWith(":") && (n += ":"),
  ...
  (e, t, r) => {
    ...
    function g(t) {
      ...
      let n,
        o,
        u,
        [a, g] = (0, l.useOptimistic)(p.IDLE_LINK_STATUS),
        b = (0, l.useRef)(null),
        {
          href: j,
          as: x,
      ...
      let $ = l.default.useContext(s.AppRouterContext),
        z = !1 !== _,
        I =
          !1 !== _
            ? null === (r = _) || "auto" === r
      ...
      let B = M ? o && "object" == typeof o && o.ref : A,
        D = l.default.useCallback(
          (e) => (
            null !== $ &&
              (b.current = (0, p.mountLinkInstance)(e, k, $, I, z, g)),
            () => {
              (b.current &&
        ...
        K = {
          ...
          onMouseEnter(e) {
            (M || "function" != typeof T || T(e),
              ...
              $ && z && (0, p.onNavigationIntent)(e.currentTarget, !0 === L));
          },
      ...
      return (
        ...
        (0, i.jsx)(v.Provider, { value: a, children: u })
      );
    }
    e.r(84508);
  ...
  (e) => {
    ...
    var i = e.i(22016);
    function l({ type: e, href: r }) {
      let l = {
        Clients: (0, t.jsx)(n, { sx: { fontSize: 50 } }),
        Profile: (0, t.jsx)(o, { sx: { fontSize: 50 } }),
        Schedule: (0, t.jsx)(u, { sx: { fontSize: 50 } }),
      };
      return (0, t.jsx)(i.default, {
        href: r,
        children: (0, t.jsx)("div", {
          className: " bg-gray-200 rounded-3xl hover:bg-amber-50",
          children: (0, t.jsxs)("div", {
            className:
              "flex flex-col items-center gap-1 hover:gap-3 transition-all justify-between w-20",
            children: [l[e], (0, t.jsx)("p", { className: "", children: e })],
          }),
        }),
      });
    }
    ...
    function d() {
      ...
      return (
        (0, s.useEffect)(
          () =>
            (0, a.onAuthStateChanged)(c.auth, (e) => {
              e ? (r(e), console.log("user: ", e)) : n.push("/");
            }),
          [],
        ),
        (0, t.jsxs)(t.Fragment, {
          children: [
            (0, t.jsxs)("div", {
              className:
                "px-2 py-1 mb-2 border-2 border-solid w-fit rounded-xl border-green-500",
              children: [e ? "Active:" : "...", " ", e?.email],
            }),
            (0, t.jsx)("div", {
              className: "flex flex-col items-center",
              children: (0, t.jsxs)("div", {
                className:
                  "flex gap-3 justify-center px-3 py-5 rounded-3xl w-2xl",
                children: [
                  (0, t.jsx)(l, { type: "Profile", href: "/profile" }),
                  (0, t.jsx)(l, { type: "Clients", href: "/clients" }),
                  (0, t.jsx)(l, { type: "Schedule", href: "/schedule" }),
                ],
              }),
            }),
          ],
