(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function m(t) {
      ...
      let n,
        o,
        u,
        [l, m] = (0, a.useOptimistic)(d.IDLE_LINK_STATUS),
        v = (0, a.useRef)(null),
        {
          href: P,
          as: _,
      ...
      let D = L ? o && "object" == typeof o && o.ref : M,
        K = a.default.useCallback(
          (e) => (
            null !== $ &&
              (v.current = (0, d.mountLinkInstance)(e, F, $, I, k, m)),
            () => {
              (v.current &&
        ...
        z = {
          ...
          onMouseEnter(e) {
            (L || "function" != typeof R || R(e),
              ...
              $ && k && (0, d.onNavigationIntent)(e.currentTarget, !0 === U));
          },
  ...
  (e) => {
    ...
    var t = e.i(43476),
      r = e.i(22016);
    function n() {
      let e = "w-100 h-20 text-black bg-blue-200 text-4xl p-2 mb-5 m-auto";
      return (0, t.jsxs)("div", {
        className: "flex flex-col p-50",
        children: [
          (0, t.jsx)(r.default, {
            href: "/login",
            className: e,
            children: (0, t.jsx)("button", { children: "Login" }),
          }),
          (0, t.jsx)(r.default, {
            href: "/signup",
            className: e,
            children: (0, t.jsx)("button", { children: "Sign Up" }),
          }),
        ],
      });
    }
